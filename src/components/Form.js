    ...
    render () {
        return <div><div className="form">
            <form >
                ...
                <br/>
                <br/>
                    <Input name="mileage" value={this.props.info.mileage} type="Number" label="Максимальный Пробег" min={0} placeholder='Введите число' onChange={this.props.handles.setMileage} />
                     <br/>
                <br/>
                    <Input name="amount" type="Number" value={this.props.info.amount} label="Минимальный Объём двигателя" min={0} step={0.1} placeholder='Введите число' onChange={this.props.handles.setAmount} />
                <br/>
                <br/>
